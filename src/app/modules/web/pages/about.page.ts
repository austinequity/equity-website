  ...
  <div class="log_body">
    <form action="#" method="get" name="loginform" onsubmit="return(loginvalidate());">
      <table width="200" border="0" align="center">
        ...
        <tr>
          <td>Don't have an account ? <a href="register.html" rel="register" style="color: darkgreen;">Sign Up</a></td>
        </tr>
      </table>
...
<footer>
  ...
  <article align="center">Patientcapital technologies @2021</article>
    ...
    styleUrls: ['../styles/main.style.scss','../styles/welcome.style.scss']
})
