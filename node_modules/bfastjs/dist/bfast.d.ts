...
export declare class bfast {
     ...
     */
    static init(options: AppCredentials, appName?: string): void;
    /**
     * get configuration  of a specific app
     * @param appName
     */
    static getConfig(appName?: string): AppCredentials;
    /**
     *
     ...
     */
    static database(appName?: string): BfastDatabase;
    /**
     *
     * @param appName other app/project name to work with
     */
    static functions(appName?: string): BfastFunctions;
    /**
    ...
    static cache(options?: {
        database: string;
        collection: string;
    }, appName?: string): CacheController;
    /**
     * get auth instance to work with authentication and authorization
     * @param appName other app/project name to work with
     */
    static auth(appName?: string): AuthController;
    /**
     * utils and enums
     */
    static utils: {
        USER_DOMAIN_NAME: string;
        POLICY_DOMAIN_NAME: string;
        TOKEN_DOMAIN_NAME: string;
     ...
     * @param appName
     */
    static storage(appName?: string): StorageController;
}
export declare const BFast: typeof bfast;
